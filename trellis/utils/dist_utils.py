...
def setup_dist(rank, local_rank, world_size, master_addr, master_port):
    ...
    # Raise the NCCL watchdog timeout (default 10 min) so heavy / imbalanced
    # validation snapshots can't trip a collective timeout on the first
    # training allreduce after validation. Overridable via NCCL_TIMEOUT_MIN.
