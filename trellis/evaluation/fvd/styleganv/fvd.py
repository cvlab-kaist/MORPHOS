# Vendored from Motion324 (https://github.com/...) at
#   Motion324/evaluation/fvd/styleganv/fvd.py
# which is itself adapted from:
#   - StyleGAN-V (https://github.com/cvpr2022-stylegan-v/stylegan-v)
#       -> src/metrics/frechet_video_distance.py
#   - https://github.com/universome/fvd-comparison
# Original code rights belong to the upstream authors / their respective
# licenses. This file is unchanged (modulo this header) so the attribution
# above is the binding source of truth.
#
# Why vendored: lets `from trellis.evaluation.fvd.styleganv.fvd import
# load_i3d_pretrained` work directly after `pip install -r requirements.txt`,
# without cloning Motion324. The I3D weights are downloaded by wget on
# first call into the same directory as this file.
...
def load_i3d_pretrained(device=torch.device('cpu')):
    ...
    if not os.path.exists(filepath):
        ...
        print(f"model found. use downloded model.")
