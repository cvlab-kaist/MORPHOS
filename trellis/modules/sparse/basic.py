...
# Eager import of backend SparseTensor class.
# (Was lazy in __init__, but module globals don't propagate from forked
# DataLoader workers back to the main process, causing replace() to crash
# in main when the worker-produced SparseTensor is .to(device)'d.)
