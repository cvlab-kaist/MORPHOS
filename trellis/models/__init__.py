...
__attributes = {
    ...
    'DiffusionForcingTemporalSSFlowModel': 'temporal_sparse_structure_flow_diffforcing',
    'DiffusionForcingTemporalSlatFlowModel': 'temporal_structured_latent_flow_diffforcing',
}
