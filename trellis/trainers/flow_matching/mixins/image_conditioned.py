...
class ImageConditionedMixin:
    ...
    def encode_image(self, image: Union[torch.Tensor, List[Image.Image]]) -> torch.Tensor:
        ...
        # Run DINOv2 under bf16 autocast so xformers' fa2F kernel can dispatch
        # on B200 (sm_100). The wheel's cutlassF/fa3F either don't support
        # sm_100 or aren't built in; fa2F is the only kernel that runs on
        # Blackwell and it requires fp16/bf16 (rejects fp32).
