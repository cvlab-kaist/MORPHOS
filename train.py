...
if __name__ == '__main__':
    ...
    parser.add_argument('--auto_retry', type=int, default=1, help='Number of retries on error')
    parser.add_argument('--reset_optimizer', action='store_true',
                        help='Skip loading optimizer state when resuming. '
                             'Use when changing trainable scope (e.g. self_attn -> transformer) '
                             'so Adam moments rebuild from zero against the new param set.')
    ## dubug
