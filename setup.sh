# Read Arguments
TEMP=`getopt -o h --long help,new-env,basic,train,xformers,flash-attn,diffoctreerast,vox2seq,spconv,mipgaussian,kaolin,nvdiffrast -n 'setup.sh' -- "$@"`
...
if [ "$NEW_ENV" = true ] ; then
    conda create -n morphos python=3.10 -y
